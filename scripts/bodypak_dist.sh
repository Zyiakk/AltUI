...
cp scripts/bodypak.py scripts/pak11_extract.py scripts/pakio.py scripts/oodle_kraken.py scripts/uasset_props.py scripts/uasset_pkg.py scripts/uasset_datatable.py build/bodypak_app/
