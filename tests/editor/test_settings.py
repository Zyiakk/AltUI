...
def main():
    ...
    mgr.set_editor_property("CamFov", 0.45); mgr.set_editor_property("ToggleKey", "G"); mgr.set_editor_property("LeftFree", 3); mgr.set_editor_property("LangChoice", 2)
    ...
    mgr.set_editor_property("CamFov", 0.8); mgr.set_editor_property("ToggleKey", "B"); mgr.set_editor_property("LeftFree", 0); mgr.set_editor_property("LangChoice", 0)
    ...
    mgr.set_editor_property("LeftFree", 0); mgr.set_editor_property("LangChoice", 0); mgr.call_method("Test Save Settings")   # leave a sane save behind
run(main)
