...
**Controls:** **B** opens / closes (changeable in Options), **Esc** closes. Left click selects / wears / applies, right click opens the context menu, mouse wheel scrolls. While the panel is open Jodi cannot walk; drag on the background to turn the camera, +/− changes the distance. The two round buttons above +/− open a free camera (mouse turns, W A S D / Q E move, Shift faster, wheel = speed, within 6 m of Jodi, stops at walls; Esc back) and the game's photo mode (Esc back).
...
| | |
|---|---|
| **Clothes** – one list per slot, group chips, search, filters ![Clothes](versions/1.4.0/screenshots/clothes-open.jpg) | **Clothes** with the group chips collapsed ("…") ![Clothes, chips collapsed](versions/1.4.0/screenshots/clothes-closed.jpg) |
| **Outfits** – the game's presets with names ![Outfits](versions/1.4.0/screenshots/outfits.jpg) | **Looks** – complete looks with photo ![Looks](versions/1.4.0/screenshots/looks.jpg) |
| **Backpack** – worn and carried items, context menu ![Backpack](versions/1.4.0/screenshots/backpack-menu-show-in-tab.jpg) | **Coiffure** – hairstyles, natural hair colours ![Coiffure](versions/1.4.0/screenshots/coiffure-natural-colours.jpg) |
| **Appearance** – skin, makeup, eyes, mod chips, search ![Appearance](versions/1.4.0/screenshots/appearance-eyes.jpg) | **Body Shape** – body switcher and bone-scale sliders ![Body Shape](versions/1.4.0/screenshots/body-shape.jpg) |
| **Manage** – your own display names ![Manage](versions/1.4.0/screenshots/manage-mods.jpg) | **Options** – key, language, camera, not-owned items, colours ![Options](versions/1.4.0/screenshots/options.jpg) |
| **Options** – slot conflicts ![Slot conflicts](versions/1.4.0/screenshots/options-slot-conflicts.jpg) | **Free camera** – a close-up from the Jodi view ![Free camera](versions/1.4.0/screenshots/free-cam.jpg) |
