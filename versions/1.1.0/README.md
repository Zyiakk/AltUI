...
| | |
|---|---|
| **Clothes** – one list per slot, search, filters ![Clothes](screenshots/clothes.jpg) | **Outfits** – the game's presets with names ![Outfits](screenshots/outfits.jpg) |
| **Looks** – complete looks with photo ![Looks](screenshots/looks.jpg) | **Backpack** – worn and carried items ![Backpack](screenshots/backpack.jpg) |
| **Coiffure** – hairstyles and hair colour ![Coiffure](screenshots/coiffure.jpg) | **Appearance** – skin, makeup, eyes, presets ![Appearance](screenshots/appearance.jpg) |
| **Body Shape** – sliders and body switcher ![Body Shape](screenshots/body-shape.jpg) | **Options** – key, language, camera, colours ![Options](screenshots/options.jpg) |
